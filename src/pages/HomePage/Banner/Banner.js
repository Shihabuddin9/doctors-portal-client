...
const Banner = () => {
    return (
        <div class="hero md:px-12 md:py-20 py-12 bg-base-200">
            <div class="hero-content flex-col lg:flex-row-reverse">
                <img src={chair} class="md:max-w-sm rounded-lg shadow-2xl" />
                <div>
                    <h1 class="md:text-5xl text-2xl font-bold">Your New Smile Starts Here</h1>
