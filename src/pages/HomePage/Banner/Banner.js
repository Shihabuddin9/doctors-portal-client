...
const Banner = () => {
    return (
        <div class="hero px-12 py-20 bg-base-200">
            <div class="hero-content flex-col lg:flex-row-reverse">
                ...
                <div>
                    ...
                    <button class="btn btn-primary uppercase font-bold text-white  bg-gradient-to-r from-accent to-primary">Get Started</button>
                </div>
            </div>
        </div>
    );
